...
export default function HowItWorks() {
  return (
    <section className="min-h-screen flex flex-col items-start gap-2 bg-[#f4f3ef] px-[96px] py-[48px]">
      <div className="flex mb-[46px]">
        <h1 className="font-space text-[40px] text-black font-bold tracking-tight">
          How it works
        </h1>
      </div>
